        ...
        <div className='form-content'>
          ...
          <div className='feature-group'>
            <div className='feature-group-text'>
              ...
              <p>Plant Buddi also lets you keep track of how well you are taking care of your little Buddi's! Want to see how often you should water them? List it here! Want to know when you last fertilized them? Update that as you go! Need to make sure you don't over water? We got you! Record it here and never forget again!</p>
            </div>
          ...
          <div className='feature-group'>
            ...
            <div className='feature-group-text'>
              ...
              <p>Plant Buddi is your one-stop-shop for all things home plant care. Anything you want to know, we can keep track of it for. And dont forget to give your Buddi a nickname! That way we can love your Buddi too!</p>
            </div>
          </div>
        </div>
      </div>
