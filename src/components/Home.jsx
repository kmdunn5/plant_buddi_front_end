        ...
        <div className='form-content'>
          ...
          <div className='feature-group'>
            ...
            <div className='feature-group-text'>
              ...
              <p className='descriptive-text'>Plant Buddi allows you to list out all of the Buddis you love and take care of! <br/>
              Get a new Buddi? You can add it! <br/>Revived an old Buddi? Add it! <br/>Sent your Buddi to a farm somewhere upstate? Delete it!</p>
            </div>
          </div>
          <div className='feature-group'>
            <div className='feature-group-text'>
              <h2>Plant Buddi Do Dat</h2>
              <p className='descriptive-text'>Plant Buddi also lets you keep track of how well you are taking care of your little Buddi's! <br/>
              Want to see how often you should water them? List it here! <br/>
              Want to know when you last fertilized them? Update that as you go!<br/> Need to make sure you don't over water? We got you!<br/> Record it here and never forget again!</p>
            </div>
